...
def get_rgbd_file_lists_tum(path_dataset):
	color_files = []
	depth_files = []
	with open(path_dataset + '/association.txt', 'r') as f:
		for line in f.readlines():
			_, img_file, _, depth_file = line.split(' ')
			color_files.append(os.path.join(path_dataset, img_file))
			depth_files.append(os.path.join(path_dataset, depth_file))
	return color_files, depth_files
